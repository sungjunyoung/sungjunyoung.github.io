...
그래프 왼쪽 끝에 회색으로 칠한 2주가 **마이그레이션 그 자체**입니다. 옮기는 데 한 주, 두 스택을 같이 띄워두고 응답을 비교하는 병행 운영에 한 주를 썼습니다. 그래서 앞의 표는 이 2주를 빼고 셌습니다. 빼기 전과 후가 크게 다르지도 않았습니다. 신규 레포의 활동일당 순증은 6,565줄에서 6,174줄이 되고, 작업 단위당 추가 라인 중앙값은 381줄 그대로입니다. 마이그레이션으로 벌어놓은 수치가 아니라 그 뒤로도 같은 속도가 유지됐다는 뜻입니다.
